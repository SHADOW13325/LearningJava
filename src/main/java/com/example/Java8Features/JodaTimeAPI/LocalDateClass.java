...
public class LocalDateClass {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("localDate = " + date.get(ChronoField.MONTH_OF_YEAR)); // We can get above values using this enum

        date = LocalDate.ofYearDay(2018, 35);
        System.out.println("LocalDate : " + date);

        date = LocalDate.of(2018, 05, 23);
        System.out.println("LocalDate = " + date);
