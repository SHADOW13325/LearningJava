...
public class Instructor implements Comparator, Comparable {
    String name;
    ...
    public int compare(Object o1, Object o2) {
        ...
        return ((Instructor) o1).getYearsOfExperience() - ((Instructor) o2).getYearsOfExperience();
    }

    @Override
    public int compareTo(Object o){
        return this.getYearsOfExperience() - ((Instructor) o).getYearsOfExperience();
    }
