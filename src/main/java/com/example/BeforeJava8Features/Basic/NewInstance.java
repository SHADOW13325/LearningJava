...
/*
 Web container don't know until run time for which servlet it has to create object.
 Therefore, the newInstance() and isInstance() method are used for that purpose which
 are replacement of new and instanceof operator.
*/
